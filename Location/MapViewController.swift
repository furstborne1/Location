...
class MapViewController: UIViewController {
    ...
    @objc func showLocationDetails(_ sender: UIButton) {
        performSegue(withIdentifier: "EditButton", sender: sender)
    }
    ...
    /***
     this is to put annotation on the map itself
     ***/
    func region(for annotations: [MKAnnotation]) -> MKCoordinateRegion {
        ...
        default:
            ...
            let span = MKCoordinateSpan(latitudeDelta: abs(topLeft.latitude -
                bottomRight.latitude) * extraSpace, longitudeDelta: abs(topLeft.longitude -
...
extension MapViewController: MKMapViewDelegate {
    ...
    /// this is to design the pinView on the map
